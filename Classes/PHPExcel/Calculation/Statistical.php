...
class PHPExcel_Calculation_Statistical
{
     ...
     * @param p require p>0
     * @param q require q>0
     * @return 0.0 if p<=0, q<=0 or p+q>2.55E305 to avoid errors and over/underflow
     */
     ...
     * @param p require p>0
     * @param q require q>0
     * @return 0.0 if x<0, p<=0, q<=0 or p+q>2.55E305 and 1 if x>1 to avoid errors and over/underflow
     */
